...
sections = {
    "1. 위험물탱크 위치, 구조 및 설비의 기준": [
        ...
        "1.4 외부구조 및 설비","1.4-1 탱크 내부 압력 해소 구조","1.4-2 탱크 부식방지 설비","1.4-3 통기관","1.4-4 자동계량식 유량계","1.4-5 주입구","1.4-6 펌프설비","1.4-7 배관 및 밸브","1.4-8 부상지붕탱크의 설비","1.4-9 전기설비","1.5 방유제","1.6 옥외탱크저장소의 특례","1.7 소화설비"
    ],
