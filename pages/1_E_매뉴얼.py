...
appendix_list = [
    ...
    {"title": "영상초음파탐상시험 시험방법 및 판정기준", "key": "영상초음파탐상시험 시험방법 및 판정기준"}
...
sections = {
    ...
    "2. 안전성능검사": ["2.1 안전성능검사 준비 및 확인사항","2.2 밑판(애뉼러판)","2.3 옆판","2.4 개구부","2.5 충수시험","2.6 구형탱크 및 기타 형상의 탱크"],
    "3. 정기검사": ["3.1 정기검사 준비 및 확인사항","3.2 두께측정시험","3.3 자기탐상시험","3.4 수직수평도시험","3.5 외관검사"],
